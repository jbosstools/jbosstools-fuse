...
public class RemoteCamelContextLaunchConfigurationTabGroupIT extends AbstractLaunchConfigurationTabGroupIT {
	...
	protected String getLaunchConfigId() {
		return "org.fusesource.ide.launcher.camelcontext.remote";
	}
