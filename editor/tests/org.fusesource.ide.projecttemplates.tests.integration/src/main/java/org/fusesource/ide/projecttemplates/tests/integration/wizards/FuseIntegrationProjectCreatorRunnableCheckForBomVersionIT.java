...
public class FuseIntegrationProjectCreatorRunnableCheckForBomVersionIT extends FuseIntegrationProjectCreatorRunnableIT {
	...
	private void checkBomVersion() throws CoreException {
		...
		assertThat(mavenProject.getProperties().getProperty("jboss.fuse.bom.version")).isEqualTo(CamelCatalogUtils.getBomVersionForCamelVersion(camelVersion, project, mavenProject.getOriginalModel(), new NullProgressMonitor()));
