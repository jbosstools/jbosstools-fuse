...
public class EAPSpringTemplateForFuse6Test {
	...
	public void testIsCompatible() throws Exception {
		assertThat(new EAPSpringTemplateForFuse6().isCompatible(new EnvironmentData(version, FuseDeploymentPlatform.STANDALONE, FuseRuntimeKind.WILDFLY))).isEqualTo(isCompatible);
	}
}
