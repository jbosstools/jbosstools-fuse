...
public class CXfCodeFirstProjectTemplateForFuse76Test {
	...
	public void testIsCompatible() throws Exception {
		assertThat(new CXfCodeFirstProjectTemplateForFuse76().isCompatible(new EnvironmentData(version, FuseDeploymentPlatform.STANDALONE, FuseRuntimeKind.KARAF))).isEqualTo(isCompatible);
	}
}
