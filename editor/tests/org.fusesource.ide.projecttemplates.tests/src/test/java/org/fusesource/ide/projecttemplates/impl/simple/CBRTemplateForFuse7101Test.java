...
public class CBRTemplateForFuse7101Test {
	...
	public void testIsCompatible() throws Exception {
		assertThat(new CBRTemplateForFuse7101().isCompatible(new EnvironmentData(version, FuseDeploymentPlatform.STANDALONE, FuseRuntimeKind.KARAF))).isEqualTo(isCompatible);
	}
