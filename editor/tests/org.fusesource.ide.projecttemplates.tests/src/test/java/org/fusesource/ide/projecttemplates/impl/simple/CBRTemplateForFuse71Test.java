...
public class CBRTemplateForFuse71Test {
	...
	public void testIsCompatible() throws Exception {
		assertThat(new CBRTemplateForFuse71().isCompatible(new EnvironmentData(version, FuseDeploymentPlatform.STANDALONE, FuseRuntimeKind.KARAF))).isEqualTo(isCompatible);
	}
