...
public class EmptyProjectTemplateForFuse7101Test {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
			{ "2.23.2.fuse-7_11-redhat-X", true },
			{ "2.23.2.fuse-7_10_1-redhat-X", true },
			{ "2.24.0", true },
	...
	public void testIsCompatible() throws Exception {
		assertThat(new EmptyProjectTemplateForFuse7101().isCompatible(new EnvironmentData(version, FuseDeploymentPlatform.STANDALONE, FuseRuntimeKind.KARAF))).isEqualTo(isCompatible);
	}
}
