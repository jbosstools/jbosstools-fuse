...
public class CXfCodeFirstProjectTemplateForFuse710Test {
	...
	public void testIsCompatible() throws Exception {
		assertThat(new CXfCodeFirstProjectTemplateForFuse710().isCompatible(new EnvironmentData(version, FuseDeploymentPlatform.STANDALONE, FuseRuntimeKind.KARAF))).isEqualTo(isCompatible);
	}
}
