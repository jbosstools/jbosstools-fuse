...
public class CBRTemplateForFuse7Test {
	...
	public void testIsCompatible() throws Exception {
		assertThat(new CBRTemplateForFuse7().isCompatible(new EnvironmentData(version, FuseDeploymentPlatform.STANDALONE, FuseRuntimeKind.KARAF))).isEqualTo(isCompatible);
	}
