...
public class DetailsSection extends NodeSectionSupport {
	...
	@Override
	protected synchronized void onNodeChanged(CamelModelElement node) {
		...
		form.setText(node != null ? String.format("%s - %s", UIMessages.propertiesDetailsTitle, DiagramUtils.filterFigureLabel(node.getDisplayText())) : UIMessages.propertiesDetailsTitle);
