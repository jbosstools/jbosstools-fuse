 ...
 *
 */
public class TextParameterPropertyModifyListenerForAdvanced extends AbstractTextParameterPropertyModifyListener {

	private Parameter parameter;
	private Component component;
	private IObservableMap modelMap;

	public TextParameterPropertyModifyListenerForAdvanced(AbstractCamelModelElement camelModelElement, Parameter parameter, IObservableMap modelMap) {
