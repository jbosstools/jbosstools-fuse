...
public class RestConfigConstants {
	...
	public static final String REST_VERB_FLAG = "restVerb"; //$NON-NLS-1$

	public static final String IMG_DESC_ADD = "icons/editor/add.png"; //$NON-NLS-1$
	public static final String IMG_DESC_DELETE = "icons/rem_co.png"; //$NON-NLS-1$
