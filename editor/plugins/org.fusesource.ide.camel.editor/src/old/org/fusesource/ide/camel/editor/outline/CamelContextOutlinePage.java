...
package old.org.fusesource.ide.camel.editor.outline;
 ...
 * @author lhein
 */
public class CamelContextOutlinePage extends ContentOutlinePage implements
		IAdaptable, IPropertyListener {
	 ...
	 */
	public CamelContextOutlinePage(EditPartViewer viewer,
			GraphicalViewer graphicalViewer, ActionRegistry actionRegistry,
			EditDomain editDomain, KeyHandler keyHandler,
			Object zoomManagerAdapter,
...
//		Diagram diagram = ((DiagramEditorInput) _diagramEditor.getEditorInput())
//				.getDiagram();
