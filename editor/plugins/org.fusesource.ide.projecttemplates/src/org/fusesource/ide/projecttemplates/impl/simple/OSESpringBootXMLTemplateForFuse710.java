...
public class OSESpringBootXMLTemplateForFuse710 extends AbstractOSESpringBootXMLTemplate {

	private static final String MINIMAL_COMPATIBLE_CAMEL_VERSION = "2.23.2.fuse-7_10_0";
	...
	public boolean isCompatible(EnvironmentData environment) {
		return super.isCompatible(environment) 
				&& environment.getCamelVersion().startsWith(MINIMAL_COMPATIBLE_CAMEL_VERSION)				
