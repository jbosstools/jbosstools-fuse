 ...
 *
 */
public class FuseRuntimeDetector extends AbstractRuntimeDetectorDelegate {
	...
	private boolean isFuseServerType(String type) {
	...
	public void computeIncludedRuntimeDefinition(
		...
		// JBoss Fuse has no nested runtime types
	}
