 ...
 * @author lhein
 */
public final class ServiceMixMockServerCreationUtil {
	 ...
	 */
	public static boolean create4xServerMock(String runtimeId, IPath runtimePath) {
		boolean serverCreated = false;
		
		// create the runtime mock structure
		if (ServiceMixMockRuntimeCreationUtil.create4xRuntimeMock(runtimeId, runtimePath)) {
	 ...
	 * @return	true on success
	 */
	public static boolean create5xServerMock(String runtimeId, IPath runtimePath) {
		boolean serverCreated = false;
		
		// create the runtime mock structure
		if (ServiceMixMockRuntimeCreationUtil.create5xRuntimeMock(runtimeId, runtimePath)) {
			// configure the runtime mock
			serverCreated = configureMockRuntime(runtimeId, runtimePath);
		}
