...
/**
 * The Node class from Camel's FilterDefinition
 *
...
public class Filter extends AbstractNode {
    ...
    public static final String PROPERTY_CUSTOMID = "Filter.CustomId";
    public static final String PROPERTY_INHERITERRORHANDLER = "Filter.InheritErrorHandler";
    ...
    protected void addCustomProperties(Map<String, PropertyDescriptor> descriptors) {
        ...
        PropertyDescriptor descCustomId = new BooleanPropertyDescriptor(PROPERTY_CUSTOMID, Messages.propertyLabelFilterCustomId);
