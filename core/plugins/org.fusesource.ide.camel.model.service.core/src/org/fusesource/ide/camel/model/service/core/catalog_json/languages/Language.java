...
import org.fusesource.ide.camel.model.service.core.catalog_json.ICamelCatalogElement;
import org.fusesource.ide.camel.model.service.core.catalog_json.IParameterContainer;
import org.fusesource.ide.camel.model.service.core.catalog_json.Parameter;
...
public class Language implements ICamelCatalogElement, IParameterContainer {
	...
	public static Language getJSONFactoryInstance(InputStream stream) {
		try {
			...
			Language model = mapper.readValue(stream, Language.class);
			return model;
