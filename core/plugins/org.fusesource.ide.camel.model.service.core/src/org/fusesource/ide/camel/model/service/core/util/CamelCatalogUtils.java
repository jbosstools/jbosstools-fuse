...
public class CamelCatalogUtils {
	...
	private static final String CAMEL_VERSION_LATEST_PRODUCTIZED_63 = FUSE_63_R3_CAMEL_VERSION;
	...
	static {
		...
		try {
			...
			OFFICIAL_SUPPORTED_CAMEL_CATALOG_VERSIONS.add(FUSE_63_R2_CAMEL_VERSION);
			OFFICIAL_SUPPORTED_CAMEL_CATALOG_VERSIONS.add(FUSE_63_R3_CAMEL_VERSION);
			OFFICIAL_SUPPORTED_CAMEL_CATALOG_VERSIONS.add(FIS_20_R0_CAMEL_VERSION);
			OFFICIAL_SUPPORTED_CAMEL_CATALOG_VERSIONS.add(FIS_20_R1_CAMEL_VERSION);	
		}
