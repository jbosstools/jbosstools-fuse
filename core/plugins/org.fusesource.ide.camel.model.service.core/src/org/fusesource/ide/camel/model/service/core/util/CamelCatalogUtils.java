...
public class CamelCatalogUtils {
	...
	protected static void initCamelVersionToTest() {
		...
		if (!Strings.isBlank(camelVersionsForTesting)) {
			...
			// Stop testing old versions due to FUSETOOLS-3692
...
//			TEST_CAMEL_VERSIONS.add(CAMEL_VERSION_LATEST_FIS_20);
			TEST_CAMEL_VERSIONS.add(CamelForFuseOnOpenShiftToBomMapper.FUSE_7111_CAMEL_VERSION);
		}
	}
	...
	public static List<String> getCamelVersionsToTestWithForOpenShiftTemplates() {
		...
		toTest.add(CamelForFuseOnOpenShiftToBomMapper.FUSE_7111_CAMEL_VERSION);
		return toTest;
	}
