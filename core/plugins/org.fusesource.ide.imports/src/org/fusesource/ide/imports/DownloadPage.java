...
import org.fusesource.ide.imports.Activator;
...
public class DownloadPage extends WizardPage {
	...
	protected DownloadPage() {
		super(Messages.DownloadPage_DownloadSAPArchiveFiles, Messages.DownloadPage_DownloadSAPArchiveFiles, Activator.getDefault().getImageRegistry().getDescriptor(Activator.WALDO48_IMAGE));
