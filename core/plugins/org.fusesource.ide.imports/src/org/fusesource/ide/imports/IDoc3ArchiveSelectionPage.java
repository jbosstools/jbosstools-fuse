...
import org.fusesource.ide.imports.ImportUtils.UnsupportedVersionException;
...
public class IDoc3ArchiveSelectionPage extends WizardPage {
	...
	protected IDoc3ArchiveSelectionPage(DataBindingContext context, IDoc3ImportSettings importSettings) {
		super(Messages.IDoc3ArchiveSelectionPage_SelectIDoc3ArchiveFile, Messages.IDoc3ArchiveSelectionPage_SelectIDoc3ArchiveFile, Activator.getDefault().getImageRegistry().getDescriptor(Activator.WALDO48_IMAGE));
