...
public class SyndesisExtensionProjectCreatorRunnableForCustomConnectorIT extends SyndesisExtensionProjectCreatorRunnableIT {
	
	@Test
	public void testCustomConnectorProjectCreation() throws CoreException, IOException, MalformedObjectNameException, InvocationTargetException, InterruptedException {
		testProjectCreation();
	}
	...
	protected AbstractProjectTemplate getTemplate() {
		return new CustomConnectorProjectTemplate();
	}
