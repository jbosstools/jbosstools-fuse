 ...
 *
 ******************************************************************************/
package org.fusesource.ide.jmx.karaf.navigator.fabric8;
...
public class BundlesTabSection extends BundlesTableView {
    ...
    public BundlesTabSection() {
        ...
        startBundleAction.setImageDescriptor(Fabric8JMXPlugin.getDefault().getImageDescriptor("start_task.gif"));
        ...
        stopBundleAction.setImageDescriptor(Fabric8JMXPlugin.getDefault().getImageDescriptor("stop_task.gif"));
        ...
        uninstallBundleAction.setImageDescriptor(Fabric8JMXPlugin.getDefault().getImageDescriptor("delete.gif"));
