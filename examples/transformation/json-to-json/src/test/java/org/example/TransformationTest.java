...
public class TransformationTest extends CamelSpringTestSupport {
    ...
    @EndpointInject(uri = "mock:json2json-test-output")
    private MockEndpoint resultEndpoint;

    @Produce(uri = "direct:json2json-test-input")
    ...
    public void transform() throws Exception {
        ...
        // run test
        startEndpoint.sendBodyAndHeader(readFile("src/data/abc-order.json"), "approval", "AUTO");
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() throws Exception {
                from("direct:json2json-test-input")
                    .log("Before transformation:\n ${body}")
                    .to("ref:json2json")
                    .log("After transformation:\n ${body}")
                    .to("mock:json2json-test-output");
            }
        };
    }
