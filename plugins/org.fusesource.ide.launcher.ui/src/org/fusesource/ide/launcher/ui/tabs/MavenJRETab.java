...
public class MavenJRETab extends JavaJRETab {
	...
	// private boolean useDefaultSeparateJRE(ILaunchConfigurationWorkingCopy
	// configuration) {
	// boolean deflt = false;
	...
	// try {
	// vmInstallType =
	// configuration.getAttribute(IJavaLaunchConfigurationConstants.ATTR_VM_INSTALL_TYPE,
	// (String) null);
	// jreContainerPath =
	// configuration.getAttribute(IJavaLaunchConfigurationConstants.ATTR_JRE_CONTAINER_PATH,
	// (String) null);
	// } catch(CoreException e) {
	// }
	// if(vmInstallType != null) {
	// configuration.setAttribute(IJavaLaunchConfigurationConstants.ATTR_VM_INSTALL_TYPE,
	// (String) null);
	// }
