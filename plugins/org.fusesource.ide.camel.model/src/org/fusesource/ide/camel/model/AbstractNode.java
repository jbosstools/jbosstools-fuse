...
public abstract class AbstractNode implements IPropertySource, IAdaptable {
	...
	/**
	 * this is a workaround for a bug in Camel 2.12 and will be most likely
	 * removed when the bug has been fixed (see
	 * https://issues.apache.org/jira/browse/CAMEL-7544)
	 * 
	 * @param def
	 */
	@Deprecated
