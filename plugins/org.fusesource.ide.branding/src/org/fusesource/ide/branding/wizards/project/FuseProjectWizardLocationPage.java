...
//    addFieldWithHistory("location", locationComponent.getLocationCombo());
    ...
    useDefaultWorkspaceLocationButton.setText(WizardMessages.MavenProjectWizardLocationPage_btnUserDefault);
    ...
    locationLabel.setText(WizardMessages.MavenProjectWizardLocationPage_lblLocation);
