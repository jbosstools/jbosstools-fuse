 ...
 * @author lhein
 */
public class Fabric8ServerWizardFragment1x extends
	...
	public Composite createComposite(Composite parent, IWizardHandle handle) {
		...
		handle.setTitle(Messages.Fabric8ServerPorpertiesComposite_wizard_title);
		handle.setDescription(Messages.Fabric8ServerPorpertiesComposite_wizard_desc);
