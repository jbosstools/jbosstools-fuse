...
public class SAPImportWizard extends Wizard implements IImportWizard {
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		this.jco3ImportSettings.setBundleDeployLocation(ImportUtils.getDefaultDeployLocation());
		...
		this.idoc3ImportSettings.setBundleDeployLocation(ImportUtils.getDefaultDeployLocation());
		...
		this.jco3ArchiveSelectionPage = new JCo3ArchiveSelectionPage(this.context, this.jco3ImportSettings);
		this.idoc3ArchiveSelectionPage = new IDoc3ArchiveSelectionPage(this.context, this.idoc3ImportSettings);
	}
	...
	public void addPages() {
		...
		addPage(this.jco3ArchiveSelectionPage);
		addPage(this.idoc3ArchiveSelectionPage);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			File file = new File(this.jco3ImportSettings.getBundleDeployLocation());
			if (!file.exists()) {
			...
			File jcoBundle = new File(this.jco3ImportSettings.getBundleFilename());
			File nativeBundle = new File(this.jco3ImportSettings.getFragmentFilename());
			File idoc3Bundle = new File(this.idoc3ImportSettings.getBundleFilename());
			...
			getContainer().run(true, true, new SAPPluginsBuilder(this.jco3ImportSettings, this.idoc3ImportSettings));
