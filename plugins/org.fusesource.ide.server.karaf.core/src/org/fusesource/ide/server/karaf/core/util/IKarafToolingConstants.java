...
public interface IKarafToolingConstants {
	...
	public static final String[] ALL_KARAF_RUNTIME_TYPES = new String[]{
		RUNTIME_KARAF_20, RUNTIME_KARAF_21, RUNTIME_KARAF_22, RUNTIME_KARAF_23, RUNTIME_KARAF_30
	};	
	...
	public static final String[] ALL_KARAF_SERVER_TYPES = new String[]{
		SERVER_KARAF_20, SERVER_KARAF_21, SERVER_KARAF_22, SERVER_KARAF_23, SERVER_KARAF_30
	};
}
