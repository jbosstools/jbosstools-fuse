...
public class ServerBeanTypeKaraf2x extends ServerBeanType {
	...
	public static class Karaf2xServerTypeCondition extends org.jboss.ide.eclipse.as.core.server.bean.AbstractCondition {
		...
		/*
		 * (non-Javadoc)
		 * @see org.jboss.ide.eclipse.as.core.server.bean.JBossServerType.Condition#getServerTypeId(java.lang.String)
		 */
		public String getServerTypeId(String version) {
			...
			if( version.equals(V2_x)) return SERVER_KARAF_2x;
			return null;
		}
	}
}
