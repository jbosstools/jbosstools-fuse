...
import org.fusesource.ide.server.karaf.core.internal.Activator;
...
public class KarafServerDelegate extends ServerDelegate implements
	...
	/* (non-Javadoc)
	 * @see org.fusesource.ide.server.karaf.core.internal.server.IServerConfiguration#getHostName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fusesource.ide.server.karaf.core.internal.server.IServerConfiguration#getPassword()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fusesource.ide.server.karaf.core.internal.server.IServerConfiguration#getPortNumber()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fusesource.ide.server.karaf.core.internal.server.IServerConfiguration#getUserName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.fusesource.ide.server.karaf.core.internal.server.IServerConfigurationWorkingCopy#setHostName(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.fusesource.ide.server.karaf.core.internal.server.IServerConfigurationWorkingCopy#setPassword(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see org.fusesource.ide.server.karaf.core.internal.server.IServerConfigurationWorkingCopy#setPortNumber(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.fusesource.ide.server.karaf.core.internal.server.IServerConfigurationWorkingCopy#setUserName(java.lang.String)
	 */
