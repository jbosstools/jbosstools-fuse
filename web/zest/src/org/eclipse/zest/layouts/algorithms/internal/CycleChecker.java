...
public class CycleChecker {
	 ...
	 */
	private static boolean hasCycle(List nodesToCheck, Map endPoints, List cycle) {
	 ...
	 */
	private static boolean hasCycle(Object nodeToCheck, List nodePathSoFar, SimpleRelationship cameFrom, Map endPoints, List nodesChecked, List cycle) {
