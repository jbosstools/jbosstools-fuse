 ...
 */
package org.jboss.chrysalix.common.i18n;
 ...
 * created from the fully-qualified class name and all "." replaced with "/" characters, "locale" is the a variant of the locale
...
public final class ClasspathLocalizationRepository {
    ...
    public static URL getLocalizationBundle( final ClassLoader classLoader,
                                             ...
                                             final Locale locale ) {
        Arg.notNull( classLoader, "classLoader" );
        URL url = null;
