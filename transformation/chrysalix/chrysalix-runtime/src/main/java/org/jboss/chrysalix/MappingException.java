...
public class MappingException extends Exception {
    ...
    public MappingException(String message, Object... parameters) {
        super(I18n.localize(MappingException.class, message, parameters));
    }

    public MappingException(Throwable e, String message, Object... parameters) {
        super(I18n.localize(MappingException.class, message, parameters), e);
    }
}
