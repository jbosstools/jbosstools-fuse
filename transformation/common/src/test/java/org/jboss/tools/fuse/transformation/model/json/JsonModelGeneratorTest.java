...
public class JsonModelGeneratorTest {
    ...
    private static String JSON_INST_PATH =
            "src/test/resources/org/jboss/tools/fuse/transformation/model/json/xyz-order.json";
    
    private static String JSON_SCHEMA_PATH =
            "src/test/resources/org/jboss/tools/fuse/transformation/model/json/xyz-order-schema.json";
