...
public class VersionsTabDescriptor extends PageTabDescriptor {
	private final Fabric node;

	public VersionsTabDescriptor(String label, Fabric node) {
		super(label);
		this.node = node;
	}
	...
	protected IPage createPage() {
		return new VersionTableSheetPage(node);
	}
}