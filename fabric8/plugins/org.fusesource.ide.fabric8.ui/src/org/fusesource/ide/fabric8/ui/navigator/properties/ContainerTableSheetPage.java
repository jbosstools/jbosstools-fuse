...
//		getTableView().addToolBarActions(openTerminalAction, startAction, stopAction, destroyAction);
	...
	protected ContainerNode getSingleSelectedRootContainerNode(List<ContainerDTO> selectedContainers) {
		ArrayList<ContainerDTO> rootContainers = Lists.newArrayList(Iterables.filter(selectedContainers, new Predicate<ContainerDTO>() {
